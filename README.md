...
ใช้การ hash รหัสผ่านก่อนบันทึกใน database ใช้ schema ของ bcrypt ในการ hash

ใช้ access token ในการจัดการข้อมูลตามสิทธิ์ที่ได้รับการเข้าถึง

มีการ mount static path สำหรับรูปภาพและอื่นๆ

เพิ่ม middleware สำหรับ gzip compressing ข้อมูลที่ส่งเมื่อมีขนาดมากกว่า 1000 bytes 

และใช้ loguru ในการทำ logging
